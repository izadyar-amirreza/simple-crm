<x-app-layout>
    <x-slot name="header">
        <div>
            <h2 class="font-semibold text-2xl text-slate-900 dark:text-gray-100">New Lead</h2>
            <p class="text-sm text-slate-500 dark:text-gray-400 mt-1">Add a lead to your pipeline.</p>
        </div>
    </x-slot>
        ...
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-slate-200 dark:border-gray-700 p-6">
                <form method="POST" action="{{ route('leads.store') }}" class="space-y-5">
                    ...
                    @include('leads._form', ['lead' => null, 'owners' => $owners])
