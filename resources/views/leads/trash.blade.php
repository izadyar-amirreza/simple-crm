<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="font-semibold text-xl leading-tight">Leads Trash</h2>
                <p class="text-white/60 text-sm mt-1">Deleted leads (Soft Delete)</p>
            </div>
                    ...
                    @forelse ($leads as $lead)
                        <tr class="hover:bg-white/5">
                            ...
                            <td class="px-4 py-3 text-white/60">
                                {{ optional($lead->deleted_at)->format('Y-m-d H:i:s') }}
                            </td>
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center justify-end gap-2">
                                    ...
                                    @can('forceDelete', $lead)
                                        <form method="POST" action="{{ route('leads.forceDelete', $lead->id) }}"
